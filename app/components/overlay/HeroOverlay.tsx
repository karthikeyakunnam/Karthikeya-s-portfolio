      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-screen">
          ...
          <div ref={contentRef} className="space-y-6 pt-24 lg:pt-0">
            ...
            >
              I design and deploy production-grade multi-agent systems,
              autonomous workflows, and AI-powered applications using LangGraph,
              RAG, and modern LLM infrastructure.
            </p>
