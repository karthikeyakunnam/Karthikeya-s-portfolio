...
const ReactorScene = dynamic(() => import("../ui/ReactorScene"), { ssr: false });
    ...
    >
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-white/45 leading-relaxed font-mono mt-4">
                  Interested in building autonomous AI systems, agentic workflows, production-grade RAG architectures, or intelligent automation?
                  <br /><br />
              ...
              {/* Form Element */}
              <form onSubmit={handleSubmit} className="space-y-4 relative z-10 flex-1 py-4">
                {/* Row 1: Name & Email */}
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="form-name" className="block text-[8px] font-mono text-primary/45 mb-1.5 uppercase tracking-wider">
                      &gt; NAME
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="form-email" className="block text-[8px] font-mono text-primary/45 mb-1.5 uppercase tracking-wider">
                      &gt; EMAIL
                    </label>
                    <input
                      type="email"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="form-company" className="block text-[8px] font-mono text-primary/45 mb-1.5 uppercase tracking-wider">
                      &gt; COMPANY (OPTIONAL)
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="form-project-type" className="block text-[8px] font-mono text-primary/45 mb-1.5 uppercase tracking-wider">
                      &gt; PROJECT TYPE
                    </label>
                    <input
                      type="text"
                ...
                {/* Message */}
                <div>
                  <label htmlFor="form-message" className="block text-[8px] font-mono text-primary/45 mb-1.5 uppercase tracking-wider">
                    &gt; PROJECT_BRIEF
                  </label>
                  <textarea
                    id="form-message"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="form-budget" className="block text-[8px] font-mono text-primary/45 mb-1.5 uppercase tracking-wider">
                      &gt; BUDGET
                    </label>
                    <select
                      id="form-budget"
                    ...
                    >
                      <option value="" className="bg-[#0c101c]">Select budget (optional)</option>
                      <option value="<5k" className="bg-[#0c101c]">&lt; $5,000</option>
                      <option value="5k-15k" className="bg-[#0c101c]">$5,000 - $15,000</option>
                      <option value="15k-50k" className="bg-[#0c101c]">$15,000 - $50,000</option>
                      <option value="50k+" className="bg-[#0c101c]">$50,000+</option>
                      <option value="open" className="bg-[#0c101c]">Open / Flexible</option>
                    </select>
                  </div>
                  <div>
                    <label htmlFor="form-timeline" className="block text-[8px] font-mono text-primary/45 mb-1.5 uppercase tracking-wider">
                      &gt; TIMELINE
                    </label>
                    <select
                      id="form-timeline"
                      ...
                      className={`${inputClasses} appearance-none cursor-pointer bg-[#0c101c]`}
                    >
                      <option value="" className="bg-[#0c101c]">Select timeline (optional)</option>
                      <option value="1-2w" className="bg-[#0c101c]">1 - 2 weeks</option>
                      <option value="1m" className="bg-[#0c101c]">1 month</option>
                      <option value="1-3m" className="bg-[#0c101c]">1 - 3 months</option>
                      <option value="3m+" className="bg-[#0c101c]">3+ months</option>
                      <option value="ongoing" className="bg-[#0c101c]">Ongoing</option>
                    </select>
                  </div>
                </div>
                ...
                {SOCIAL_LINKS.map((link, idx) => (
                  ...
                  >
                    <div
                      ...
                      style={{ backgroundColor: idx % 2 === 0 ? "#00E5FF" : "#7C3AED" }}
                    />
                    ...
                    <span className="text-[9px] font-mono text-white/70 font-semibold truncate group-hover:text-primary transition-colors mt-1">
                      {link.label === "Phone" ? "+91 86880 84787" : link.href.replace(/^https?:\/\/(www\.)?/, "").replace(/^mailto:/, "")}
                    </span>
                  </a>
                ))}
              </div>
          ...
          <div id="contact-reactor-side" className="lg:col-span-7 flex flex-col justify-center items-center opacity-0 h-full min-h-[500px]">
                ...
                <div className="flex items-center gap-2">
                  <span 
                    className={`w-2 h-2 rounded-full transition-all duration-300 ${
                      hoveredAgent ? "animate-pulse" : "bg-[#00E5FF] animate-ping"
                    }`}
                    style={{ backgroundColor: hoveredAgent ? hoveredAgent.color : undefined }}
                  />
              ...
              {hoveredAgent ? (
                <div className="space-y-2 animate-fade-in">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-bold font-display uppercase" style={{ color: hoveredAgent.color }}>
                      {hoveredAgent.name}
                    </span>
                  </div>
                  <div>
                ...
                <div className="space-y-1.5 py-2 text-[10px] text-white/40">
                  <p className="animate-pulse">&gt;&gt; SYSTEM IS STABLE. ALL 6 COGNITIVE AGENTS ACTIVE.</p>
                  <p className="text-[9px] text-white/20 font-medium">
                    &gt;&gt; HOVER OVER ANY ORBITAL AGENT NODE TO PROBE OPERATIONAL CORE SPECS.
                  </p>
                </div>
              )}
            </div>
