...
export default function SceneManager() {
  ...
  useFrame(() => {
    ...
    const fromIndex = Math.min(Math.floor(totalProgress), CAMERA_STATES.length - 2);
    ...
    camera.rotation.x = THREE.MathUtils.lerp(camera.rotation.x, targetRot.current.x, lerpSpeed);
    camera.rotation.y = THREE.MathUtils.lerp(camera.rotation.y, targetRot.current.y, lerpSpeed);
